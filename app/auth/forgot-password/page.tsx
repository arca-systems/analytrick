      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 28 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: '#6b7280' }}>Recuperar senha</div>
          </div>
        </div>
        ...
        {success ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: '#9ca3af', lineHeight: 1.6, marginBottom: 24 }}>
              Enviamos um link para <strong style={{ color: '#f9fafb' }}>{email}</strong>.
              Clique no link para criar uma nova senha.
            </div>
            <Link href="/auth/login" style={{
              display: 'block', background: '#374151', borderRadius: 8,
              color: '#f9fafb', fontSize: 13, fontWeight: 600, padding: '12px',
